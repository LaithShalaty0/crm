...
// Custom Reports
$route['admin/custom_reports'] = 'custom_reports/index';
// $route['admin/custom_reports/leads_monthly_report/(:num)'] = 'custom_reports/leads_monthly_report/$1';

$route['admin/custom_reports/generate_report'] = 'custom_reports/generate_report';
