...
*
*/
define('APP_BASE_URL', 'https://crm.azyankhozam.com/');
...
*/
define('APP_ENC_KEY', '89b0c0a18a5be0ff92c960f245a36862');
 ...
 */
define('APP_DB_USERNAME', 'tatwwcxl_azyankhozamcrmuser');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'SYYBE,E7MNN8');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'tatwwcxl_azyankhozamcrm');
