      ...
      <div class="col-md-12">
               ...
               <div class="horizontal-tabs">
                  ...
                  <ul class="nav-tabs-horizontal nav nav-tabs<?php if (!isset($lead)) {
                     ...
                     <?php if (isset($lead)) { ?>
                        ...
                        <?php } ?>
                        <li role="presentation">
                           <a href="#tab_call_logs_leads" onclick="initDataTable('.table-call_logs-lead', admin_url + 'call_logs/call_log_relations/' + <?php echo $lead->id; ?> + '/lead','undefined', 'undefined','undefined',[6,'desc']);" aria-controls="tab_call_logs_leads" role="tab" data-toggle="tab">
         ...
         <div class="tab-content mtop20">
            ...
            <?php if (isset($lead)) { ?>
               ...
               <div role="tabpanel" class="tab-pane" id="tab_call_logs_leads">
                  <?php if (has_permission('call_logs', '', 'create')) { ?>
                     <a href="<?php echo admin_url('call_logs/call_log?customer_type=lead&clientid=' . $lead->id); ?>" class="btn btn-info mbot25"><?php echo 'Create New Call Log'; ?></a>
                  <?php } ?>
                  <?php
                  $table_data = array(
                     _l('cl_type'),
                  ...
                  $table_data = hooks()->apply_filters('call_logs_relation_table_columns', $table_data);
                  render_datatable($table_data, 'call_logs-lead', [], [
                     'data-last-order-identifier' => 'call_logs-relation',
                     'data-default-order'         => get_table_last_order('call_logs-relation'),
                  ]);
                  ?>
               </div>
            <?php } ?>
