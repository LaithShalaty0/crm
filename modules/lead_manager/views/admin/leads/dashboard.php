                  ...
                  <div id="dashboard-data">
                     <div class="row">
                           ...
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total">
                                    <?php echo isset($audio_calls['outgoing']) ? $audio_calls['outgoing'] : 0; ?></h3>
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total">
                                    <?php echo isset($audio_calls['incoming']) ? $audio_calls['incoming'] : 0; ?></h3>
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total"><?php echo $leads_converted ? $leads_converted : 0; ?>
                                 </h3>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total">
                                    <?php
                                    echo (isset($zoom['sheduled']) ? $zoom['sheduled'] : 0) +
                                       (isset($zoom['cancelled']) ? $zoom['cancelled'] : 0) +
                                       (isset($zoom['completed']) ? $zoom['completed'] : 0);
                                    ?>
                                 </h3>
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total"><?php echo $zoom['sheduled'] ? $zoom['sheduled'] : 0; ?>
                                 </h3>
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total">
                                    <?php echo $zoom['completed'] ? $zoom['completed'] : 0; ?></h3>
                     ...
                     <div class="row">
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total">
                                    <?php echo isset($audio_calls_duration['incoming']) ? $audio_calls_duration['incoming'] : '00:00:00'; ?>
                                 </h3>
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                           <div class="panel_s">
                              <div class="panel-body">
                                 <h3 class="text-muted _total">
                                    <?php echo isset($audio_calls_duration['outgoing']) ? $audio_calls_duration['outgoing'] : '00:00:00'; ?>
                                 </h3>
                        ...
                        <?php if (is_admin()) { ?>
                           <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                              <div class="panel_s">
                                 <div class="panel-body">
                                    <h3 class="text-muted _total">
                                       $<?php echo isset($twilio['balance']) ? $twilio['balance'] : '0:00'; ?>
                                    </h3>
                           ...
                           <div class="col-lg-3 col-xs-12 col-md-12 total-column">
                              <div class="panel_s">
                                 <div class="panel-body">
                                    <h3 class="text-muted _total">
                                       <?php echo isset($twilio['numbers']) ? $twilio['numbers'] : '0'; ?>
                                    </h3>
