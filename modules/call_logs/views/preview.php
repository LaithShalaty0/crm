...
<?php
    ...
    $contactid = '';
    if(isset($call_log) && isset($call_log->contactid)){
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group select-placeholder <?php if($contactid == ''){echo ' hide';} ?> " id="contactid_wrapper">
                            ...
                            <div id="contactid_select">
                                <select disabled="" name="contactid" id="contactid" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    <?php if($contactid != ''){
                                        $contact = get_contact($contactid);
                                        echo '<option value="'.$contact->id.'" selected>'.$contact->firstname.' '.$contact->lastname.'</option>';
                                    } ?>
                                </select>
                            </div>
                        </div>
