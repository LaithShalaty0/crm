			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<h4 class="pull-left"><?php echo _l('custom_reports') . " - " . _l('tasks_filter'); ?> <small
								class="text-success"><?php echo $saved_filter_name; ?></small></h4>
						<div class="btn-group pull-right mleft4 btn-with-tooltip-group" data-toggle="tooltip"
							data-title="<?php echo _l('filter_templates'); ?>" data-original-title="" title="">
						...
						<button type="submit" data-toggle="tooltip" data-title="<?php echo _l('si_apply_filter'); ?>"
						...
						<div class="row">
							...
							<div class="col-md-2 text-center1 border-right">
								...
								<div class="form-group no-margin select-placeholder">
									<select name="status[]" id="status" class="selectpicker no-margin" data-width="100%"
										data-title="<?php echo _l('task_status'); ?>" multiple>
										<option value="" <?php if (in_array('', $statuses)) {
											echo 'selected';
										} ?>>
											<?php echo _l('task_list_all'); ?></option>
										<?php foreach ($task_statuses as $status) { ?>
											<option value="<?php echo $status['id']; ?>" <?php if (in_array($status['id'], $statuses)) {
												   echo 'selected';
											   } ?>>
							...
							<div class="col-md-2 border-right form-group">
								<label for="billable" class="control-label"><span
										class="control-label"><?php echo _l('task_billable'); ?></span></label>
								<select name="billable" id="billable" class="selectpicker no-margin" data-width="100%">
									...
									<option value="1" <?php echo ($billable != '' && $billable == "1" ? 'selected' : '') ?>>
										<?php echo _l('Yes'); ?></option>
									<option value="0" <?php echo ($billable != '' && $billable == "0" ? 'selected' : '') ?>>
										<?php echo _l('No'); ?></option>
								</select>
							</div>
							<!--end billable select-->
							<!--start rel type-->
							<div class="col-md-2 border-right">
								...
								<select name="rel_type" class="selectpicker" id="si_tf_rel_type" data-width="100%"
									data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
									<option value=""></option>
									<option value="project" <?php if (isset($rel_type)) {
										if ($rel_type == 'project') {
											echo 'selected';
										}
									} ?>><?php echo _l('project'); ?></option>
									<option value="invoice" <?php if (isset($rel_type)) {
										if ($rel_type == 'invoice') {
											echo 'selected';
										}
									} ?>><?php echo _l('invoice'); ?></option>
									<option value="customer" <?php if (isset($rel_type)) {
										if ($rel_type == 'customer') {
											echo 'selected';
										}
									} ?>><?php echo _l('client'); ?></option>
									<option value="estimate" <?php if (isset($rel_type)) {
										if ($rel_type == 'estimate') {
											echo 'selected';
										}
									} ?>><?php echo _l('estimate'); ?></option>
									<option value="contract" <?php if (isset($rel_type)) {
										if ($rel_type == 'contract') {
											echo 'selected';
										}
									} ?>><?php echo _l('contract'); ?></option>
									<option value="ticket" <?php if (isset($rel_type)) {
										if ($rel_type == 'ticket') {
											echo 'selected';
										}
									} ?>><?php echo _l('ticket'); ?></option>
									<option value="expense" <?php if (isset($rel_type)) {
										if ($rel_type == 'expense') {
											echo 'selected';
										}
									} ?>><?php echo _l('expense'); ?></option>
									<option value="lead" <?php if (isset($rel_type)) {
										if ($rel_type == 'lead') {
											echo 'selected';
										}
									} ?>><?php echo _l('lead'); ?></option>
									<option value="proposal" <?php if (isset($rel_type)) {
							...
							<div class="col-md-2 border-right form-group<?php if ($rel_id == '' && $rel_type == '') {
								echo ' hide';
							} ?>"
								id="si_tf_rel_id_wrapper">
								<label for="rel_id" class="control-label"><span
										class="si_tf_rel_id_label"></span></label>
								<div id="si_tf_rel_id_select">
									<select name="rel_id" id="si_tf_rel_id" class="ajax-search" data-width="100%"
							...
							<div class="col-md-2 border-right form-group<?php if ($rel_type !== 'customer') {
								echo ' hide';
							} ?>"
								id="group_id_wrapper">
								<label for="group_id" class="control-label"><span
										class="control-label"><?php echo _l('customer_groups'); ?></span></label>
								<div id="group_id_select">
									<select name="group_id" id="group_id" class="selectpicker no-margin"
										data-width="100%">
										<option value="" selected><?php echo _l('dropdown_non_selected_tex'); ?>
										</option>
										<?php if (!empty($groups)) {
						...
						<div class="row">
							...
							<div class="col-md-2 border-right form-group">
								<label for="group_id" class="control-label"><span
										class="control-label"><?php echo _l('group_by_task'); ?></span></label>
								<select name="group_by" id="group_by" class="selectpicker no-margin" data-width="100%">
									...
									<option value="rel_name" <?php echo ($group_by != '' && $group_by == 'rel_name' ? 'selected' : '') ?>><?php echo _l('task_related_to'); ?>
									</option>
									<option value="rel_name_and_name" <?php echo ($group_by != '' && $group_by == 'rel_name_and_name' ? 'selected' : '') ?>>
										<?php echo _l('task_related_to_and_name'); ?></option>
									<option value="name_and_rel_name" <?php echo ($group_by != '' && $group_by == 'name_and_rel_name' ? 'selected' : '') ?>>
										<?php echo _l('task_name_and_related_to'); ?></option>
									<option value="task_name" <?php echo ($group_by != '' && $group_by == 'task_name' ? 'selected' : '') ?>><?php echo _l('filter_task_name'); ?>
									</option>
							...
							<div class="col-md-2 border-right form-group">
								<label for="hide_columns" class="control-label"><span
										class="control-label"><?php echo _l('hide_export_columns'); ?></span></label>
								<select name="hide_columns[]" id="hide_columns" class="selectpicker no-margin"
									data-width="100%" multiple>
									<option value=""><?php echo _l('dropdown_non_selected_tex'); ?></option>
									<option value="name" <?php echo (in_array('name', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('tasks_dt_name'); ?></option>
									<?php
									...
									<option value="start_date" <?php echo (in_array('start_date', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('tasks_dt_datestart'); ?></option>
									<option value="due_date" <?php echo (in_array('due_date', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('task_duedate'); ?></option>
									<option value="completed_date" <?php echo (in_array('completed_date', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('task_completed_date'); ?></option>
									<option value="billable" <?php echo (in_array('billable', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('task_billable'); ?></option>
									<option value="attachments" <?php echo (in_array('attachments', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('tasks_total_added_attachments'); ?></option>
									<option value="comments" <?php echo (in_array('comments', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('tasks_total_comments'); ?></option>
									<option value="checklist" <?php echo (in_array('checklist', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('task_checklist_items'); ?></option>
									<option value="logged_time" <?php echo (in_array('logged_time', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('staff_stats_total_logged_time'); ?></option>
									<option value="on_time" <?php echo (in_array('on_time', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('task_finished_on_time'); ?></option>
									<option value="assigned" <?php echo (in_array('assigned', $hide_columns) ? 'selected' : '') ?>>
										<?php echo _l('task_assigned'); ?></option>
							...
							<div class="col-md-2 border-right form-group<?php if ($date_by == '') {
								echo ' hide';
							} ?>"
								id="date_by_wrapper">
								<label for="date_by" class="control-label"><span
										class="control-label"><?php echo _l('task_filter_by_date'); ?></span></label>
								<select name="date_by" id="date_by" class="selectpicker no-margin" data-width="100%">
									...
									<option value="datefinished" <?php echo ($date_by != '' && $date_by == 'datefinished' ? 'selected' : '') ?>>
										<?php echo _l('task_completed_date'); ?></option>
								</select>
							</div>
									...
									<div class="col-md-6">
										...
										<div class="input-group date">
											<input type="text" class="form-control datepicker" id="report_from"
												name="report_from" value="<?php echo $report_from; ?>"
												autocomplete="off">
							...
							<div class="col-md-10">
								<div class="checklist relative">
									<div class="checkbox checkbox-success checklist-checkbox" data-toggle="tooltip"
										title="" data-original-title="<?php echo _l('save_filter_template'); ?>">
										<input type="checkbox" id="si_save_filter" name="save_filter" value="1"
											title="<?php echo _l('save_filter_template'); ?>" <?php echo ($this->input->get('filter_id') ? 'checked' : '') ?>>
										<label for=""><span
												class="hide"><?php echo _l('save_filter_template'); ?></span></label>
										<textarea id="si_filter_name" name="filter_name" rows="1"
											placeholder="<?php echo _l('filter_template_name'); ?>" <?php echo ($this->input->get('filter_id') ? '' : 'disabled="disabled"') ?>
								...
								<thead>
									<tr>
										<?php if (($group_by !== 'rel_name_and_name' && $group_by !== 'name_and_rel_name') || $month == '') { ?>
											<th class="<?php echo (in_array('name', $hide_columns) ? 'not-export' : '') ?>">
												<?php echo _l('tasks_dt_name'); ?></th>
										<?php } ?>
										<?php
										$custom_fields = get_custom_fields('tasks', ['show_on_table' => 1,]);
										foreach ($custom_fields as $field) {
										...
										<th class="<?php echo (in_array('status', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_status'); ?></th>
										<th class="<?php echo (in_array('start_date', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('tasks_dt_datestart'); ?></th>
										<th class="<?php echo (in_array('due_date', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_duedate'); ?></th>
										<th class="<?php echo (in_array('completed_date', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_completed_date'); ?></th>
										<th class="<?php echo (in_array('billable', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_billable'); ?></th>
										<th class="<?php echo (in_array('attachments', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('tasks_total_added_attachments'); ?></th>
										<th class="<?php echo (in_array('comments', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('tasks_total_comments'); ?></th>
										<th class="<?php echo (in_array('checklist', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_checklist_items'); ?></th>
										<th class="<?php echo (in_array('logged_time', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('staff_stats_total_logged_time'); ?></th>
										<th class="<?php echo (in_array('on_time', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_finished_on_time'); ?></th>
										<th class="<?php echo (in_array('assigned', $hide_columns) ? 'not-export' : '') ?>">
											<?php echo _l('task_assigned'); ?></th>
								...
								<tbody>
									...
									foreach ($data as $task) { ?>
										<tr>
											...
											<td data-order="<?php echo $task['datefinished']; ?>">
												<?php echo _d($task['datefinished']); ?></td>
											<td data-order="<?php echo $task['billable']; ?>">
												<?php echo ($task['billable'] ? 'Yes' : 'No'); ?></td>
											<td data-order="<?php echo $task['total_files']; ?>">
												<span class="label label-default-light" data-toggle="tooltip"
													...
													<a <?php if ($task['total_files'] > 0)
														echo 'href="' . admin_url('tasks/download_files/' . $task['id']) . '"'; ?>
														class="bold" disabled>
											...
											<td>
												<span
													class="label <?php if ($task['total_checklist_items'] == '0') {
														echo 'label-default-light';
													} else if (($task['total_finished_checklist_items'] != $task['total_checklist_items'])) {
														echo 'label-danger';
													} else if ($task['total_checklist_items'] == $task['total_finished_checklist_items']) {
														echo 'label-success';
													} ?> pull-left mright5"
													data-toggle="tooltip"
											...
											<td data-order="<?php echo $task['total_logged_time']; ?>">
												<span class="label label-default-light pull-left mright5" data-toggle="tooltip"
											...
											$finishedOrder = 0;
											if (!empty($task['datefinished']) && !empty($task['duedate'])) {
											...
											<td><?php echo render_tags(prep_tags_input(get_tags_in($task['id'], 'task'))); ?>
											</td>
										</tr>
									<?php } ?>
								</tbody>
