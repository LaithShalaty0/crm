...
$fn_get_data = function () {
  ...
  $widget_req_from = !empty ($period_from) ? date('Y-m-d', strtotime($period_from)) : null;
  $widget_req_to = !empty ($period_to) ? date('Y-m-d', strtotime($period_to)) : null;
  ...
  foreach ($data_rows as $data_row) {
    $data_labels[] = $data_row['staff_fullname'];
    $data_leads[] = intval($data_row['total_leads']);
    $data_converted_leads[] = intval($data_row['total_converted_leads']);
  }
